...
public class ModBlocks {
    ...
    public static final Block BLAZE_ROD_BLOCK = registerBlock("blaze_rod_block", new ReversiblePillarBlock(FabricBlockSettings.of().instrument(Instrument.COW_BELL).mapColor(MapColor.TERRACOTTA_YELLOW).requiresTool().strength(2.0f).sounds(ModBlockSoundGroup.BLAZE_ROD_BLOCK).luminance(state -> 15))/*,ModItemGroups.SQUASHED*/);
    public static final Block INK_SAC_BLOCK = registerBlock("ink_sac_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BLACK).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block STICK_BLOCK = registerBlock("stick_block", new PillarBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.OAK_TAN).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block FIRE_CHARGE_BLOCK = registerBlock("fire_charge_block", new FireChargeBlock(FabricBlockSettings.of().instrument(Instrument.BASEDRUM).mapColor(MapColor.GRAY).strength(0.5f).sounds(BlockSoundGroup.GRAVEL))/*,ModItemGroups.SQUASHED*/);
    public static final Block MAGMA_CREAM_BLOCK = registerBlock("magma_cream_block", new MagmaCreamBlock(FabricBlockSettings.of().mapColor(MapColor.ORANGE).sounds(BlockSoundGroup.HONEY).nonOpaque().luminance(state -> 7))/*,ModItemGroups.SQUASHED*/);
    public static final Block BLAZE_POWDER_BLOCK = registerBlock("blaze_powder_block", new FallingBlock(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.TERRACOTTA_YELLOW).strength(0.5f).sounds(BlockSoundGroup.SNOW).luminance(state -> 11))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_SALMON_BLOCK = registerBlock("raw_salmon_block", new Block(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.TERRACOTTA_PINK).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_SALMON_BLOCK = registerBlock("cooked_salmon_block", new Block(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.BRIGHT_RED).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_COD_BLOCK = registerBlock("raw_cod_block", new Block(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.PALE_YELLOW).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_COD_BLOCK = registerBlock("cooked_cod_block", new Block(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_RABBIT_BLOCK = registerBlock("raw_rabbit_block", new Block(FabricBlockSettings.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_RABBIT_BLOCK = registerBlock("cooked_rabbit_block", new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_MUTTON_BLOCK = registerBlock("raw_mutton_block", new Block(FabricBlockSettings.of().mapColor(MapColor.TERRACOTTA_PINK).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_MUTTON_BLOCK = registerBlock("cooked_mutton_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DIRT_BROWN).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_CHICKEN_BLOCK = registerBlock("raw_chicken_block", new Block(FabricBlockSettings.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_CHICKEN_BLOCK = registerBlock("cooked_chicken_block", new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_BEEF_BLOCK = registerBlock("raw_beef_block", new Block(FabricBlockSettings.of().mapColor(MapColor.RED).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_BEEF_BLOCK = registerBlock("cooked_beef_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DIRT_BROWN).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block RAW_PORK_BLOCK = registerBlock("raw_pork_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PINK).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COOKED_PORK_BLOCK = registerBlock("cooked_pork_block", new Block(FabricBlockSettings.of().mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    public static final Block ROTTEN_FLESH_BLOCK = registerBlock("rotten_flesh_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_RED).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block SPIDER_EYE_BLOCK = registerBlock("spider_eye_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_CRIMSON).strength(0.5f).sounds(BlockSoundGroup.MUD))/*,ModItemGroups.SQUASHED*/);
    public static final Block WHEAT_SEED_BLOCK = registerBlock("wheat_seed_block", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.EMERALD_GREEN).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block PUMPKIN_SEED_BLOCK = registerBlock("pumpkin_seed_block", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block BEETROOT_SEED_BLOCK = registerBlock("beetroot_seed_block", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block MELON_SEED_BLOCK = registerBlock("melon_seed_block", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.BLACK).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block COCOA_BEANS_BLOCK = registerBlock("cocoa_beans_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BROWN).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block GLOW_BERRIES_BLOCK = registerBlock("glow_berries_block", new WaterloggableFullBlock(FabricBlockSettings.of().mapColor(MapColor.GREEN).strength(0.2f).sounds(BlockSoundGroup.GRASS).luminance(state -> 7).burnable().nonOpaque().allowsSpawning(ModBlocks::never).suffocates(ModBlocks::never).blockVision(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY).solidBlock(ModBlocks::never))/*,ModItemGroups.SQUASHED*/);
    public static final Block SWEET_BERRIES_BLOCK = registerBlock("sweet_berries_block", new WaterloggableFullBlock(FabricBlockSettings.of().mapColor(MapColor.GREEN).strength(0.2f).sounds(BlockSoundGroup.SWEET_BERRY_BUSH).burnable().nonOpaque().allowsSpawning(ModBlocks::never).suffocates(ModBlocks::never).blockVision(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY).solidBlock(ModBlocks::never))/*,ModItemGroups.SQUASHED*/);
    public static final Block GRASS_CLIPPINGS_BLOCK = registerBlock("grass_clippings_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(0.2f).sounds(BlockSoundGroup.MOSS_BLOCK).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block FERN_BLOCK = registerBlock("fern_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(0.2f).burnable().sounds(BlockSoundGroup.MOSS_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block GLOW_LICHEN_BLOCK = registerBlock("glow_lichen_block", new Block(FabricBlockSettings.of().mapColor(MapColor.LICHEN_GREEN).strength(0.2f).sounds(BlockSoundGroup.MOSS_BLOCK).luminance(state -> 7))/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_PUMPKIN = registerBlock("compressed_pumpkin", new FallingBlock(FabricBlockSettings.of().instrument(Instrument.DIDGERIDOO).mapColor(MapColor.ORANGE).strength(2.0f).sounds(BlockSoundGroup.WOOD))/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_HAY_BLOCK = registerBlock("compressed_hay_block", new HayBlock(FabricBlockSettings.of().instrument(Instrument.BANJO).mapColor(MapColor.PALE_YELLOW).strength(0.2f).sounds(BlockSoundGroup.GRASS).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_MELON = registerBlock("compressed_melon", new FallingBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(2.0f).sounds(BlockSoundGroup.WOOD))/*,ModItemGroups.SQUASHED*/);
    public static final Block SUGARCANE_BLOCK = registerBlock("sugarcane_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block SEA_PICKLE_BLOCK = registerBlock("sea_pickle_block", new SeaPickleBlock(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).luminance(ModBlocks.createLightLevelFromProperty(15, Properties.WATERLOGGED)).strength(2.0f).sounds(BlockSoundGroup.CORAL))/*, ModItemGroups.SQUASHED*/);
    ...
    public static final Block[] COMPACTED_STONE = registerCompactedBlockSet("stone",
            new Block(FabricBlockSettings.of().sounds(BlockSoundGroup.STONE).strength(1.5f, 6.0f).requiresTool().instrument(Instrument.BASEDRUM)),
            new Block(FabricBlockSettings.of().sounds(BlockSoundGroup.STONE).strength(1.5f, 6.0f).requiresTool().instrument(Instrument.BASEDRUM)),
            new Block(FabricBlockSettings.of().sounds(BlockSoundGroup.STONE).strength(1.5f, 6.0f).requiresTool().instrument(Instrument.BASEDRUM)),
            new Block(FabricBlockSettings.of().sounds(BlockSoundGroup.STONE).strength(1.5f, 99.0f).requiresTool().instrument(Instrument.BASEDRUM))
    );
    ...
    public static final Block[] COMPACTED_GRAVEL = registerCompactedBlockSet("gravel",
            new Block(FabricBlockSettings.copyOf(Blocks.GRAVEL).strength(0.8f).instrument(Instrument.SNARE)),
            new Block(FabricBlockSettings.copyOf(Blocks.GRAVEL).strength(1.2f).instrument(Instrument.SNARE)),
    ...
    public static final Block[] COMPACTED_SNOW_BLOCKS = registerCompactedBlockSet("snow_block",
            new Block(FabricBlockSettings.of().strength(0.2f).mapColor(MapColor.WHITE).sounds(BlockSoundGroup.SNOW)),
            new Block(FabricBlockSettings.of().strength(0.2f).mapColor(MapColor.WHITE).sounds(BlockSoundGroup.SNOW)),
            new Block(FabricBlockSettings.of().strength(1.4f, 6.0f).mapColor(MapColor.WHITE).sounds(BlockSoundGroup.STONE)),
            new Block(FabricBlockSettings.of().strength(1.4f, 99.0f).mapColor(MapColor.WHITE).sounds(BlockSoundGroup.STONE))
    );
    ...
    public static final Block[] COMPACTED_GLOWSTONE_BLOCKS = registerCompactedBlockSet("glowstone",
            new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.3f).instrument(Instrument.PLING).sounds(BlockSoundGroup.GLASS).luminance(state -> 15).solidBlock(ModBlocks::never)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.3f).instrument(Instrument.PLING).sounds(BlockSoundGroup.GLASS).luminance(state -> 15).solidBlock(ModBlocks::never)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.5f).instrument(Instrument.PLING).sounds(BlockSoundGroup.GLASS).luminance(state -> 15).solidBlock(ModBlocks::never)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.5f).instrument(Instrument.PLING).sounds(BlockSoundGroup.GLASS).luminance(state -> 15).solidBlock(ModBlocks::never))
            );
    ...
    public static final Block[] COMPACTED_COPPER_BLOCKS = registerCompactedBlockSet("copper_block",
            new OxidizableBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of().mapColor(MapColor.ORANGE).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER)),
            new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER))
    );
    public static final Block COMPRESSED_COPPER_BLOCK = COMPACTED_COPPER_BLOCKS[0]; // silly, but it's for a temporary convenience
    public static final Block EXPOSED_COMPRESSED_COPPER_BLOCK = registerBlockWithCompressionTier("exposed_compressed_copper_block", 0, new OxidizableBlock(Oxidizable.OxidationLevel.EXPOSED, FabricBlockSettings.of().mapColor(MapColor.ORANGE).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER))/*,ModItemGroups.SQUASHED*/);
    public static final Block WEATHERED_COMPRESSED_COPPER_BLOCK = registerBlockWithCompressionTier("weathered_compressed_copper_block", 0, new OxidizableBlock(Oxidizable.OxidationLevel.WEATHERED, FabricBlockSettings.of().mapColor(MapColor.LICHEN_GREEN).requiresTool().strength(1.5f,6.0f).sounds(BlockSoundGroup.COPPER))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block WHITE_DYE_BLOCK = registerBlock("white_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.WHITE).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block ORANGE_DYE_BLOCK = registerBlock("orange_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.ORANGE).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block MAGENTA_DYE_BLOCK = registerBlock("magenta_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.MAGENTA).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block LIGHT_BLUE_DYE_BLOCK = registerBlock("light_blue_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.LIGHT_BLUE).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block YELLOW_DYE_BLOCK = registerBlock("yellow_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.YELLOW).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block LIME_DYE_BLOCK = registerBlock("lime_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.LIME).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block PINK_DYE_BLOCK = registerBlock("pink_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.PINK).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block GRAY_DYE_BLOCK = registerBlock("gray_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.GRAY).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block LIGHT_GRAY_DYE_BLOCK = registerBlock("light_gray_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.LIGHT_GRAY).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block CYAN_DYE_BLOCK = registerBlock("cyan_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.CYAN).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block PURPLE_DYE_BLOCK = registerBlock("purple_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.PURPLE).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block BLUE_DYE_BLOCK = registerBlock("blue_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.BLUE).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block BROWN_DYE_BLOCK = registerBlock("brown_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.BROWN).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block GREEN_DYE_BLOCK = registerBlock("green_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.GREEN).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block RED_DYE_BLOCK = registerBlock("red_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.RED).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    public static final Block BLACK_DYE_BLOCK = registerBlock("black_dye_block", createDyeBlock(FabricBlockSettings.of().mapColor(MapColor.BLACK).strength(0.3f).sounds(BlockSoundGroup.FROGSPAWN))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block BOOK_BLOCK = registerBlock("book_block", new Block(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.DIRT_BROWN).strength(2.0f).sounds(BlockSoundGroup.NETHER_WOOD).burnable())/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block LEATHER_BLOCK = registerBlock("leather_block", new PillarBlock(FabricBlockSettings.of().instrument(Instrument.COW_BELL).mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.8f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block COMPRESSED_CHERRY_SAPLING = registerBlock("compressed_cherry_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.PINK).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_OAK_SAPLING = registerBlock("compressed_oak_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.OAK_TAN).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_SPRUCE_SAPLING = registerBlock("compressed_spruce_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.SPRUCE_BROWN).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_BIRCH_SAPLING = registerBlock("compressed_birch_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.PALE_YELLOW).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_JUNGLE_SAPLING = registerBlock("compressed_jungle_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.OAK_TAN).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_ACACIA_SAPLING = registerBlock("compressed_acacia_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.TERRACOTTA_ORANGE).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_DARK_OAK_SAPLING = registerBlock("compressed_dark_oak_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.TERRACOTTA_GRAY).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_AZALEA_SAPLING = registerBlock("compressed_azalea_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.OAK_TAN).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_FLOWERING_AZALEA_SAPLING = registerBlock("compressed_flowering_azalea_sapling", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.OAK_TAN).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_MANGROVE_PROPAGULE = registerBlock("compressed_mangrove_propagule", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.DARK_CRIMSON).strength(0.5f).sounds(BlockSoundGroup.ROOTED_DIRT).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_CRIMSON_FUNGUS = registerBlock("compressed_crimson_fungus", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.DARK_DULL_PINK).strength(0.5f).sounds(BlockSoundGroup.WART_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_WARPED_FUNGUS = registerBlock("compressed_warped_fungus", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.BRIGHT_TEAL).strength(0.5f).sounds(BlockSoundGroup.WART_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block CHORUS_FRUIT_BLOCK = registerBlock("chorus_fruit_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_DULL_PINK).strength(2.0f).sounds(BlockSoundGroup.WART_BLOCK))/*,ModItemGroups.SQUASHED*/);

    public static final Block COMPRESSED_SEAGRASS = registerBlock("compressed_seagrass", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).strength(0.2f).sounds(BlockSoundGroup.WET_GRASS))/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_CACTUS = registerBlock("compressed_cactus", new PillarBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(0.8f).sounds(BlockSoundGroup.WOOL).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_A = registerBlock("tropical_fish_block_a", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_B = registerBlock("tropical_fish_block_b", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_C = registerBlock("tropical_fish_block_c", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_D = registerBlock("tropical_fish_block_d", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_E = registerBlock("tropical_fish_block_e", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_F = registerBlock("tropical_fish_block_f", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_G = registerBlock("tropical_fish_block_g", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_H = registerBlock("tropical_fish_block_h", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_I = registerBlock("tropical_fish_block_i", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_J = registerBlock("tropical_fish_block_j", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_K = registerBlock("tropical_fish_block_k", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_L = registerBlock("tropical_fish_block_l", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_M = registerBlock("tropical_fish_block_m", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_N = registerBlock("tropical_fish_block_n", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_O = registerBlock("tropical_fish_block_o", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_P = registerBlock("tropical_fish_block_p", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_Q = registerBlock("tropical_fish_block_q", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_R = registerBlock("tropical_fish_block_r", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_S = registerBlock("tropical_fish_block_s", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_T = registerBlock("tropical_fish_block_t", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block TROPICAL_FISH_BLOCK_U = registerBlock("tropical_fish_block_u", createTropicalFishBlock(FabricBlockSettings.of().instrument(Instrument.BASS).mapColor(MapColor.ORANGE).strength(0.5f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK))/*,ModItemGroups.SQUASHED*/);

    public static final Block PRISMARINE_CRYSTAL_BLOCK = registerBlock("prismarine_crystal_block", new Block(FabricBlockSettings.of().instrument(Instrument.HAT).mapColor(MapColor.OFF_WHITE).strength(3.0f, 6.0f).sounds(BlockSoundGroup.TUFF).luminance(state -> 15))/*,ModItemGroups.SQUASHED*/);
    public static final Block GLOW_INK_SAC_BLOCK = registerBlock("glow_ink_sac_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_TEAL).strength(0.5f).sounds(BlockSoundGroup.MUD).luminance(state -> 7))/*,ModItemGroups.SQUASHED*/);
    public static final Block SCUTE_BLOCK = registerBlock("scute_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).strength(1.5f,6.0f).sounds(BlockSoundGroup.CANDLE))/*,ModItemGroups.SQUASHED*/);
    public static final Block FEATHER_BLOCK = registerBlock("feather_block", new FeatherBlock(FabricBlockSettings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BANJO).strength(0.2f).sounds(BlockSoundGroup.WOOL).burnable().nonOpaque().allowsSpawning(ModBlocks::always).solidBlock(ModBlocks::always).blockVision(ModBlocks::always).suffocates(ModBlocks::always))/*,ModItemGroups.SQUASHED*/);
    public static final Block GHAST_TEAR_BLOCK = registerBlock("ghast_tear_block", new Block(FabricBlockSettings.of().mapColor(MapColor.OFF_WHITE).strength(3.0f, 6.0f).sounds(BlockSoundGroup.TUFF))/*,ModItemGroups.SQUASHED*/);
    public static final Block PHANTOM_MEMBRANE_BLOCK = registerBlockWithoutBlockItem("phantom_membrane_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PALE_YELLOW).sounds(BlockSoundGroup.CORAL))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block COMPRESSED_NETHER_WART_BLOCK = registerBlock("compressed_nether_wart_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DULL_RED).strength(0.5f).sounds(BlockSoundGroup.WART_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_WARPED_WART_BLOCK = registerBlock("compressed_warped_wart_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_TEAL).strength(0.5f).sounds(BlockSoundGroup.WART_BLOCK))/*,ModItemGroups.SQUASHED*/);
    public static final Block MANGROVE_ROOTS_BLOCK = registerBlock("mangrove_roots_block", new PillarBlock(FabricBlockSettings.of().mapColor(MapColor.TERRACOTTA_GRAY).strength(2.0f).sounds(BlockSoundGroup.WOOD).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block VINE_BLOCK = registerBlock("vine_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).strength(0.2f).sounds(BlockSoundGroup.MOSS_BLOCK).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block EGG_BLOCK = registerBlock("egg_block", new EggsBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_YELLOW).strength(0.5f).sounds(BlockSoundGroup.CANDLE))/*,ModItemGroups.SQUASHED*/);
    public static final Block PUFFERFISH_BLOCK = registerBlock("pufferfish_block", new PufferfishBlock(FabricBlockSettings.of().mapColor(MapColor.YELLOW).strength(0.5f).sounds(BlockSoundGroup.CORAL))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block BONES_BLOCK = registerBlock("bones_block", new PillarBlock(FabricBlockSettings.of().mapColor(MapColor.OFF_WHITE).strength(1.5f,6.0f).instrument(Instrument.XYLOPHONE).sounds(BlockSoundGroup.BONE))/*,ModItemGroups.SQUASHED*/);
    public static final Block PAPER_BLOCK = registerBlock("paper_block", new Block(FabricBlockSettings.of().mapColor(MapColor.OFF_WHITE).strength(0.5f).sounds(BlockSoundGroup.BIG_DRIPLEAF).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block COMPRESSED_SCAFFOLDING = registerBlock("compressed_scaffolding", new PillarBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_YELLOW).strength(2.0f).sounds(BlockSoundGroup.SCAFFOLDING).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block KELP_BLOCK = registerBlock("kelp_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).strength(0.2f).sounds(BlockSoundGroup.WET_GRASS))/*,ModItemGroups.SQUASHED*/);
    public static final Block LILY_PAD_BLOCK = registerBlock("lily_pad_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DARK_GREEN).strength(0.2f).sounds(BlockSoundGroup.WET_GRASS))/*,ModItemGroups.SQUASHED*/);
    public static final Block ENDER_EYE_BLOCK = registerBlock("ender_eye_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_TEAL).strength(0.5f).sounds(BlockSoundGroup.FROGLIGHT))/*,ModItemGroups.SQUASHED*/);
    public static final Block ENDER_PEARL_BLOCK = registerBlock("ender_pearl_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_TEAL).strength(0.5f).sounds(BlockSoundGroup.FROGLIGHT))/*,ModItemGroups.SQUASHED*/);
    public static final Block ECHO_SHARD_BLOCK = registerBlock("echo_shard_block", new Block(FabricBlockSettings.of().mapColor(MapColor.TERRACOTTA_GRAY).strength(0.5f).sounds(BlockSoundGroup.SCULK_CATALYST))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block RABBIT_HIDE_BLOCK = registerBlock("rabbit_hide_block", new PillarBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_YELLOW).strength(0.5f).sounds(BlockSoundGroup.FUNGUS))/*,ModItemGroups.SQUASHED*/);
    //TODO add to composting registry
    public static final Block CARROT_BLOCK = registerBlock("carrot_block", new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block GOLDEN_CARROT_BLOCK = registerBlock("golden_carrot_block", new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.5f).sounds(BlockSoundGroup.NETHER_ORE))/*,ModItemGroups.SQUASHED*/);
    public static final Block APPLE_BLOCK = registerBlock("apple_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_RED).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block GOLDEN_APPLE_BLOCK = registerBlock("golden_apple_block", new Block(FabricBlockSettings.of().mapColor(MapColor.GOLD).strength(0.5f).sounds(BlockSoundGroup.NETHER_ORE))/*,ModItemGroups.SQUASHED*/);
    public static final Block POTATO_BLOCK = registerBlock("potato_block", new Block(FabricBlockSettings.of().mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block POISONOUS_POTATO_BLOCK = registerBlock("poisonous_potato_block", new Block(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block BAKED_POTATO_BLOCK = registerBlock("baked_potato_block", new Block(FabricBlockSettings.of().mapColor(MapColor.RAW_IRON_PINK).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block BEETROOT_BLOCK = registerBlock("beetroot_block", new Block(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_RED).strength(0.5f).sounds(BlockSoundGroup.AZALEA))/*,ModItemGroups.SQUASHED*/);
    public static final Block FLINT_BLOCK = registerBlock("flint_block", new Block(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.GRAY).strength(1.5f,6.0f).sounds(BlockSoundGroup.TUFF))/*,ModItemGroups.SQUASHED*/);
    public static final Block SUGAR_BLOCK = registerBlock("sugar_block", new SugarBlock(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.OFF_WHITE).strength(0.5f).sounds(BlockSoundGroup.SAND).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block GUNPOWDER_BLOCK = registerBlock("gunpowder_block", new GunpowderBlock(FabricBlockSettings.of().instrument(Instrument.SNARE).mapColor(MapColor.LIGHT_GRAY).strength(0.5f).sounds(BlockSoundGroup.SAND).burnable().solidBlock(ModBlocks::never))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block CRYSTAL_QUARTZ_BLOCK = registerBlock("crystal_quartz_block", new ReversiblePillarBlock(FabricBlockSettings.of().instrument(Instrument.SNARE).strength(0.75f))/*, ModItemGroups.SQUASHED*/);
    public static final Block HEART_OF_THE_SEA_BLOCK = registerBlock("heart_of_the_sea_block", new Block(FabricBlockSettings.of().mapColor(MapColor.DIAMOND_BLUE).strength(1.2f).requiresTool().sounds(BlockSoundGroup.METAL))/*, ModItemGroups.SQUASHED*/);
    public static final Block NAUTILUS_SHELL_BLOCK = registerBlock("nautilus_shell_block", new Block(FabricBlockSettings.of().mapColor(MapColor.OFF_WHITE).sounds(BlockSoundGroup.SUSPICIOUS_SAND).strength(0.75f))/*, ModItemGroups.SQUASHED*/);
    ...
    public static final Block GLOWSTONE_DUST_BLOCK = registerBlock("glowstone_dust_block", new FallingBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.PLING).strength(0.5f).sounds(BlockSoundGroup.SAND).luminance(state -> 15)));
    public static final Block REDSTONE_DUST_BLOCK = registerBlock("redstone_dust_block", new RedstoneDustBlock(FabricBlockSettings.of().mapColor(MapColor.BRIGHT_RED).strength(0.5f).sounds(BlockSoundGroup.SAND)));
    public static final Block COMPRESSED_SHROOMLIGHT = registerBlock("compressed_shroomlight", new Block(FabricBlockSettings.of().mapColor(MapColor.RED).strength(1.0f).sounds(BlockSoundGroup.SHROOMLIGHT).luminance(state -> 15)));
    public static final Block COMPRESSED_HONEY_BLOCK = registerBlock("compressed_honey_block", new HoneyBlock(FabricBlockSettings.of().mapColor(MapColor.ORANGE).velocityMultiplier(0.4f).jumpVelocityMultiplier(0.5f).sounds(BlockSoundGroup.HONEY)));
    public static final Block COMPRESSED_SLIME_BLOCK = registerBlock("compressed_slime_block", new SlimeBlock(FabricBlockSettings.of().mapColor(MapColor.PALE_GREEN).slipperiness(0.8f).sounds(BlockSoundGroup.SLIME)));
    public static final Block CLAY_BALL_BLOCK = registerBlock("clay_ball_block", new NoisyFallingBlock(FabricBlockSettings.of().mapColor(MapColor.LIGHT_BLUE_GRAY).instrument(Instrument.FLUTE).strength(0.6f).instrument(Instrument.FLUTE).sounds(BlockSoundGroup.MUD), SoundEvents.BLOCK_MUD_STEP, 1.8f, 1.0f));
    public static final Block EXPERIENCE_BLOCK = registerBlock("experience_block", new ExperienceBlock(FabricBlockSettings.of().mapColor(MapColor.YELLOW).strength(0.2f).sounds(ModBlockSoundGroup.EXPERIENCE_BLOCK).instrument(Instrument.PLING).emissiveLighting(ModBlocks::always).luminance(state -> 1))); //TODO consider making a custom BlockSoundGroup for this
    public static final Block NETHERITE_SCRAP_BLOCK = registerBlock("netherite_scrap_block", new Block(FabricBlockSettings.of().requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.NETHERITE)));
    public static final Block COMPRESSED_HONEYCOMB_BLOCK = registerBlock("compressed_honeycomb_block", new Block(FabricBlockSettings.of().mapColor(MapColor.ORANGE).strength(0.6f).sounds(BlockSoundGroup.CORAL)));
...
//    }
    ...
    public static LeafPileBlock createCompressedLeavesBlock(MapColor mapColor, BlockSoundGroup blockSoundGroup) {
        return new LeafPileBlock(FabricBlockSettings.of().mapColor(mapColor).strength(0.2f).sounds(blockSoundGroup).nonOpaque().allowsSpawning(ModBlocks::never).suffocates(ModBlocks::never).blockVision(ModBlocks::never).burnable().pistonBehavior(PistonBehavior.DESTROY).solidBlock(ModBlocks::never));
    }
