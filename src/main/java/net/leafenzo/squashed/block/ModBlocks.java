...
public class ModBlocks {
    ...
    public static final Block MAGMA_CREAM_BLOCK = registerBlock("magma_cream_block", new MagmaCreamBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.HONEY).nonOpaque()),ModItemGroups.SQUASHED);
    ...
    public static final Block TROPICAL_FISH_BLOCK_A = registerBlock("tropical_fish_block_a", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_B = registerBlock("tropical_fish_block_b", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_C = registerBlock("tropical_fish_block_c", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_D = registerBlock("tropical_fish_block_d", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_E = registerBlock("tropical_fish_block_e", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_F = registerBlock("tropical_fish_block_f", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_G = registerBlock("tropical_fish_block_g", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_H = registerBlock("tropical_fish_block_h", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_I = registerBlock("tropical_fish_block_i", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_J = registerBlock("tropical_fish_block_j", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_K = registerBlock("tropical_fish_block_k", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_L = registerBlock("tropical_fish_block_l", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_M = registerBlock("tropical_fish_block_m", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_N = registerBlock("tropical_fish_block_n", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_O = registerBlock("tropical_fish_block_o", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_P = registerBlock("tropical_fish_block_p", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_Q = registerBlock("tropical_fish_block_q", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_R = registerBlock("tropical_fish_block_r", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_S = registerBlock("tropical_fish_block_s", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_T = registerBlock("tropical_fish_block_t", new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    ...
    public static final Block COMPRESSED_COPPER_BLOCK = registerBlock("compressed_copper_block", new OxidizableBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.COPPER)),ModItemGroups.SQUASHED);
