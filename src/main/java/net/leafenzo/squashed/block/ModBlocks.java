...
public class ModBlocks {
    ...
    public static final Block TROPICAL_FISH_BLOCK_A = registerBlock("tropical_fish_block_a", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_B = registerBlock("tropical_fish_block_b", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_C = registerBlock("tropical_fish_block_c", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_D = registerBlock("tropical_fish_block_d", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_E = registerBlock("tropical_fish_block_e", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_F = registerBlock("tropical_fish_block_f", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_G = registerBlock("tropical_fish_block_g", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_H = registerBlock("tropical_fish_block_h", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_I = registerBlock("tropical_fish_block_i", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_J = registerBlock("tropical_fish_block_j", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_K = registerBlock("tropical_fish_block_k", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_L = registerBlock("tropical_fish_block_l", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_M = registerBlock("tropical_fish_block_m", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_N = registerBlock("tropical_fish_block_n", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_O = registerBlock("tropical_fish_block_o", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_P = registerBlock("tropical_fish_block_p", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_Q = registerBlock("tropical_fish_block_q", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_R = registerBlock("tropical_fish_block_r", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_S = registerBlock("tropical_fish_block_s", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
    public static final Block TROPICAL_FISH_BLOCK_T = registerBlock("tropical_fish_block_t", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(ModBlockSoundGroup.TROPICAL_FISH_BLOCK)),ModItemGroups.SQUASHED);
