...
public class ModBlocks {
    ...
    public static final Block FEATHER_BLOCK = registerBlock("feather_block", new FeatherBlock(FabricBlockSettings.copyOf(Blocks.STONE).mapColor(MapColor.OFF_WHITE).instrument(Instrument.BANJO).strength(0.2f).sounds(BlockSoundGroup.WOOL).burnable().nonOpaque())/*,ModItemGroups.SQUASHED*/);
