...
public class ModBlocks {
    ...
    public static final Block GRASS_CLIPPINGS_BLOCK = registerBlock("grass_clippings_block", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_GREEN).strength(0.2f).sounds(BlockSoundGroup.MOSS_BLOCK).burnable())/*,ModItemGroups.SQUASHED*/);
    public static final Block FERN_BLOCK = registerBlock("fern_block", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_GREEN).strength(0.2f).burnable().sounds(BlockSoundGroup.MOSS_BLOCK))/*,ModItemGroups.SQUASHED*/);
    ...
    public static final Block FLINT_BLOCK = registerBlock("flint_block", new Block(FabricBlockSettings.create().instrument(Instrument.SNARE).mapColor(MapColor.GRAY).strength(1.5f,6.0f).sounds(BlockSoundGroup.TUFF))/*,ModItemGroups.SQUASHED*/);
