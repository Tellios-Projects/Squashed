...
public class ModBlocks {
    ...
    public static final Block COMPRESSED_OAK_LEAVES = registerBlock("compressed_oak_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_SPRUCE_LEAVES = registerBlock("compressed_spruce_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.FLOWERING_AZALEA)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_BIRCH_LEAVES = registerBlock("compressed_birch_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_JUNGLE_LEAVES = registerBlock("compressed_jungle_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_ACACIA_LEAVES = registerBlock("compressed_acacia_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_DARK_OAK_LEAVES = registerBlock("compressed_dark_oak_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_MANGROVE_LEAVES = registerBlock("compressed_mangrove_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
    public static final Block COMPRESSED_AZALEA_LEAVES = registerBlock("compressed_azalea_leaves", new Block(FabricBlockSettings.of(Material.STONE).strength(2.0f).sounds(BlockSoundGroup.AZALEA_LEAVES)),ModItemGroups.SQUASHED);
