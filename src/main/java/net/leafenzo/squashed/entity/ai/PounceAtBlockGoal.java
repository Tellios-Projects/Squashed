...
// */
//package net.leafenzo.squashed.entity.ai;
//
...
//
//public class PounceAtBlockGoal
//extends Goal {
//    private final MobEntity mob;
//    protected BlockPos targetPos = BlockPos.ORIGIN;
//    private final float velocity;
//
//    public PounceAtBlockGoal(MobEntity mob, float velocity) {
//        this.mob = mob;
...
//            return false;
//        }
//        return this.mob.getRandom().nextInt(this.toGoalTicks(5)) == 0;
//    }
//
//    @Override
